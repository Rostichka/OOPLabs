//Создать следующий шаблон класса:
//– массив элементов.
//Тип данных элементов массива является параметризированным (шаблонным); 
//– число элементов массива; 
//– метод поиска индекса элемента в массиве, согласно варианту; !!!Варіант 11 - методы поиска с вставкой в дерево
//– конструктор для автоматической инициализации уникального массива элементов, заданной длины.
//– деструктор (при необходимости).
// Продемонстрировать работу шаблона на разных базовых целочисленных типах данных. 
